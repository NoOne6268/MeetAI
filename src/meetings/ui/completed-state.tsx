          ...
          <div className="bg-white rounded-lg border px-4 py-5">
            {data.recordingUrl ? (
              ...
              <EmptyState
                ...
                description="Recording links are only available for 2 weeks on the free plan. Please upgrade to a paid plan to retain access to recordings for longer periods."
              />
            )}
          </div>
        </TabsContent>
          ...
          <div className="bg-white rounded-lg border">
            <div className="px-4 py-5 gap-y-5 flex flex-col col-span-5">
              ...
              <div>
                <Markdown components={{
                    h1: (props) => (
                        <h1 className="text-2xl font-medium bg-6" {...props} />
                    ),
                    h2: (props) => (
                        <h2 className="text-xl font-medium bg-6" {...props} />
                    ),
                    h3: (props) => (
                        <h3 className="text-lg font-medium bg-6" {...props} />
                    ),
                    h4: (props) => (
                        <h4 className="text-base font-medium bg-6" {...props} />
                    ),
